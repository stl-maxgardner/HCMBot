...
Next deploy command:
  gcloud builds submit \\
    ...
    --substitutions=_SERVICE_NAME=${SERVICE_NAME},_REGION=${REGION},_VERTEX_LOCATION=${REGION},_VERTEX_MODEL=gemini-2.5-flash,_RUNTIME_SERVICE_ACCOUNT=${RUNTIME_SA_EMAIL},_SLACK_ALLOWED_TEAM_IDS=${SLACK_ALLOWED_TEAM_IDS},_SLACK_ALLOWED_APP_IDS=${SLACK_ALLOWED_APP_IDS},_HCM_DOC_BASE_URL=,_HCM_DOC_URL_MAP_B64=
