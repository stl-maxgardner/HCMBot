# Highway Capacity Manual (HCM) PDF Knowledge Base

## Documents Loaded

| File | Short Title | Description | Pages |
|------|-------------|-------------|-------|
| pdf1.pdf | HCM 1985 (3rd Ed.) | Highway Capacity Manual, Special Report 209 (1985), Transportation Research Board | 508 |
...
### HCM 1985 — Special Report 209 (pdf1.pdf)
- Chapter 1: Concepts of Highway Capacity
- Chapter 2: Traffic Characteristics
- Chapter 3: Basic Freeway Segments
- Chapter 4: Weaving Areas
...
### HCM 6th Edition — Volume 1: Concepts (pdf2.pdf)
...
- Chapter 8: Traffic Characteristics
- Chapter 9: Analytical Procedures Overview
- Chapter 10: Urban Street Concepts
- Chapter 11: Pedestrian and Bicycle Concepts
- Chapter 12: Highway Concepts
- Chapter 13: Freeway Concepts
- Chapter 14: Transit Concepts
...
- Chapter 29: Corridor Analysis
- Chapter 30: Areawide Analysis
- Chapter 31: Simulation and Other Models

### HCM 2010 — 5th Edition (pdf4.pdf)
- Chapter 1: HCM User's Guide
- Chapter 2: Applications
- Chapter 3: Modal Characteristics
- Chapter 4: Traffic Flow and Capacity Concepts
- Chapter 5: Quality and Level-of-Service Concepts
- Chapter 6: HCM and Alternative Analysis Tools
- Chapter 7: Interpreting HCM and Alternative Tool Results
- Chapter 9: Glossary and Symbols
...
Use `python3 /workspace/pdfs/search_pdfs.py "<query>"` to search across all documents.

The knowledge base is stored in `knowledge_base.json` with full page-by-page text extraction.
